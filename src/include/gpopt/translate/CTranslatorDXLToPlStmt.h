...
namespace gpdxl
{
	...
	class CTranslatorDXLToPlStmt
	{
		...
		typedef Plan * (CTranslatorDXLToPlStmt::*PfPplan)(const CDXLNode *dxlnode, CDXLTranslateContext *output_context, Plan *parent_plan, CDXLTranslationContextArray *ctxt_translation_prev_siblings);
