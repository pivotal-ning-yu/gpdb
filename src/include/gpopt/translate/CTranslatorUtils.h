...
namespace gpdxl
{
	...
	class CTranslatorUtils
	{
		...
		public:
			...
			static
			CDXLNode *CreateDXLProjElemFromInt4Const(IMemoryPool *mp, CMDAccessor *md_accessor, INT val);
			...
			static
			BOOL IsGroupingColumn(const SortClause *group_clause, List *group_clause_list);
