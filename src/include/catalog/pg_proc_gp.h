...
/* gp_expand_get_status(OUT code int4, OUT status text, OUT detail text) => SETOF pg_catalog.record */
DATA(insert OID = 5082 ( gp_expand_get_status  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" "{23,25,25}" "{o,o,o}" "{code,status,detail}" _null_ gp_expand_get_status _null_ _null_ _null_ n m ));
DESCR("Get gpexpand status");
