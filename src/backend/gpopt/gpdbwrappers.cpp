	...
	)
{
	GP_WRAP_START;
	{
		...
		return get_cast_func(src_oid, dest_oid, is_binary_coercible, cast_fn_oid);
	}
	GP_WRAP_END;
	return false;
}
	...
	)
{
	GP_WRAP_START;
	{
		return get_index_opclasses(index_oid);
	}
	GP_WRAP_END;
	...
	)
{
	GP_WRAP_START;
	{
		return evaluate_expr(expr, result_type);
	}
	GP_WRAP_END;
	return NULL;
}
	...
	)
{
	GP_WRAP_START;
	{
		return defGetString(defelem, needs_free);
	}
	GP_WRAP_END;
	return NULL;
}
