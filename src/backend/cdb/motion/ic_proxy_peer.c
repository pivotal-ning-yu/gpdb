...
/*
 * Received a DATA or MESSAGE packet from a remote peer.
 */
static void
...
ic_proxy_peer_on_close(uv_handle_t *handle)
{
	...
	/* reset the state, only keep the loopback status */
	peer->state = 0;
