 ...
 */
extern bool get_attstatsslot_desc(TupleDesc tupdesc, AttStatsSlot *slot, HeapTuple statstuple,
...
get_attstatsslot(AttStatsSlot *sslot, HeapTuple statstuple,
				 int reqkind, Oid reqop, int flags)
{
	return get_attstatsslot_desc(NULL, sslot, statstuple,
			reqkind, reqop, flags);
}
...
bool
get_attstatsslot_desc(TupleDesc tupdesc, AttStatsSlot *sslot, HeapTuple statstuple,
				 int reqkind, Oid reqop, int flags)
{
