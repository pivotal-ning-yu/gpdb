							 ...
							 Plan *lefttree)
{
	...
	context->path->locus.partkey_h = CdbPartKey_Copy(context->input_locus.partkey_h);
	context->path->locus.partkey_oj = CdbPartKey_Copy(context->input_locus.partkey_oj);
					   ...
					   Plan *lefttree)
{
	...
	context->input_locus.partkey_h = CdbPartKey_Copy(context->path->locus.partkey_h);
	context->input_locus.partkey_oj = CdbPartKey_Copy(context->path->locus.partkey_oj);
	context->pathkeys = NIL;
