...
DROP EXTERNAL TABLE IF EXISTS tbl_ext_fixedwidth_x;
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth_x ( 
            s1 char(10), s2 varchar(10), s3 text, dt timestamp,   
            n1 smallint, n2 integer, n3 bigint, n4 decimal,       
            n5 numeric, n6 real, n7 double precision) 
        LOCATION ('gpfdist://10.110.120.137/gpfdist_end_of_line/data/fixedwidth_small_correct_x.tbl')   
        FORMAT 'CUSTOM' (formatter='fxwd_in', s1='10',             
            s2='10', s3='10', dt='20',n1='5', n2='10',                                                                                                                                      
            n3='10', n4='10', n5='10', n6='10', n7='15',line_delim='x');
...
CREATE WRITABLE EXTERNAL TABLE tbl_out_fixedwidth (
        ...
        FORMAT 'CUSTOM' (formatter='fxwd_out', s1='10', 
            s2='10', s3='10', dt='20', n1='5', n2='10', 
            n3='10', n4='10', n5='10', n6='10', n7='15',line_delim='xxxxxxxxxxxxxxxxxxxx');  
DROP TABLE IF EXISTS tbl_on_heap;
CREATE TABLE tbl_on_heap (
            s1 char(10), s2 varchar(10), s3 text, dt timestamp, 
            n1 smallint, n2 integer, n3 bigint, n4 decimal, 
            n5 numeric, n6 real, n7 double precision);
INSERT INTO tbl_on_heap SELECT * FROM tbl_ext_fixedwidth_x;
