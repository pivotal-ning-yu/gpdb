...
DROP EXTERNAL TABLE IF EXISTS tbl_ext_fixedwidth_shtrodel;
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth_shtrodel ( 
            s1 char(10), s2 varchar(10), s3 text, dt timestamp,   
            n1 smallint, n2 integer, n3 bigint, n4 decimal,       
            n5 numeric, n6 real, n7 double precision) 
        LOCATION ('gpfdist://10.110.120.137/gpfdist_end_of_line/data/fixedwidth_small_correct_shtrodel.tbl')   
...
CREATE TABLE tbl_on_heap (
            ...
            n1 smallint, n2 integer, n3 bigint, n4 decimal, 
            n5 numeric, n6 real, n7 double precision);
INSERT INTO tbl_on_heap SELECT * FROM tbl_ext_fixedwidth_shtrodel;
