...
setup_gptransfer() {
    ...
    setup_ssh_to_both_clusters
    exchange_keys
    ssh -t mdw "source /home/gpadmin/gpdb_src/ci/concourse/scripts/transfer_utils.sh; create_map_file"
    ssh -t mdw-2 "source /home/gpadmin/gpdb_src/ci/concourse/scripts/transfer_utils.sh; allow_connections_from_all_hosts"
}
