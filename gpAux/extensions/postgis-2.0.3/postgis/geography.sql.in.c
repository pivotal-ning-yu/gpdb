...
CREATE OR REPLACE FUNCTION ST_AsSVG(geog geography,rel int4, maxdecimaldigits int4)
	RETURNS text
	AS 'MODULE_PATHNAME','geography_as_svg'
	LANGUAGE 'c' IMMUTABLE STRICT;


CREATE OR REPLACE FUNCTION ST_AsSVG(geog geography,rel int4)
	RETURNS text
        AS 'SELECT ST_AsSVG($1, $2, 15)'
        LANGUAGE 'sql' IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION ST_AsSVG(geog geography)
	RETURNS text
        AS 'SELECT ST_AsSVG($1, 0, 15)'
        LANGUAGE 'sql' IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION ST_AsGML(geog geography, maxdecimaldigits int4, options int4)
	RETURNS text
	AS 'SELECT _ST_AsGML(2, $1, $2, $3, null)'
	LANGUAGE 'sql' IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION ST_AsGML(geog geography, maxdecimaldigits int4)
	RETURNS text
	AS 'SELECT _ST_AsGML(2, $1, $2, 0, null)'
	LANGUAGE 'sql' IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION ST_AsGML(geog geography)
	RETURNS text
...
CREATE OR REPLACE FUNCTION ST_AsGML(version int4, geog geography, maxdecimaldigits int4, options int4, nprefix text)
	RETURNS text
	AS $$ SELECT _ST_AsGML($1, $2, $3, $4, $5);$$
	LANGUAGE 'sql' IMMUTABLE;

CREATE OR REPLACE FUNCTION ST_AsGML(version int4, geog geography, maxdecimaldigits int4, options int4)
	RETURNS text
	AS $$ SELECT _ST_AsGML($1, $2, $3, $4, NULL);$$
	LANGUAGE 'sql' IMMUTABLE;

CREATE OR REPLACE FUNCTION ST_AsGML(version int4, geog geography, maxdecimaldigits int4)
	RETURNS text
	AS $$ SELECT _ST_AsGML($1, $2, $3, 0, NULL);$$
	LANGUAGE 'sql' IMMUTABLE;

CREATE OR REPLACE FUNCTION ST_AsGML(version int4, geog geography)
	RETURNS text
...
-- Changed: 2.0.0 to use default args and named args
CREATE OR REPLACE FUNCTION ST_AsKML(geog geography, maxdecimaldigits int4)
	RETURNS text
	AS 'SELECT _ST_AsKML(2, $1, $2, null)'
	LANGUAGE 'sql' IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION ST_AsKML(geog geography)
	RETURNS text
...
-- Changed: 2.0.0 to use default args and named args
CREATE OR REPLACE FUNCTION ST_AsKML(version int4, geog geography, maxdecimaldigits int4, nprefix text)
	RETURNS text
	AS 'SELECT _ST_AsKML($1, $2, $3, $4)'
	LANGUAGE 'sql' IMMUTABLE;

CREATE OR REPLACE FUNCTION ST_AsKML(version int4, geog geography, maxdecimaldigits int4)
	RETURNS text
	AS 'SELECT _ST_AsKML($1, $2, $3, null)'
	LANGUAGE 'sql' IMMUTABLE;

CREATE OR REPLACE FUNCTION ST_AsKML(version int4, geog geography)
	RETURNS text
...
-- Changed: 2.0.0 to use default args and named args
CREATE OR REPLACE FUNCTION ST_AsGeoJson(geog geography, maxdecimaldigits int4, options int4)
	RETURNS text
	AS $$ SELECT _ST_AsGeoJson(1, $1, $2, $3); $$
	LANGUAGE 'sql' IMMUTABLE STRICT;


CREATE OR REPLACE FUNCTION ST_AsGeoJson(geog geography, maxdecimaldigits int4)
	RETURNS text
	AS $$ SELECT _ST_AsGeoJson(1, $1, $2, 0); $$
	LANGUAGE 'sql' IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION ST_AsGeoJson(geog geography)
	RETURNS text
...
-- Changed: 2.0.0 to use default args and named args
CREATE OR REPLACE FUNCTION ST_AsGeoJson(gj_version int4, geog geography, maxdecimaldigits int4, options int4)
	RETURNS text
	AS $$ SELECT _ST_AsGeoJson($1, $2, $3, $4); $$
	LANGUAGE 'sql' IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION ST_AsGeoJson(gj_version int4, geog geography, maxdecimaldigits int4)
	RETURNS text
	AS $$ SELECT _ST_AsGeoJson($1, $2, $3, 0); $$
	LANGUAGE 'sql' IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION ST_AsGeoJson(gj_version int4, geog geography)
	RETURNS text
...
-- Availability: 1.5.0
CREATE OR REPLACE FUNCTION ST_Area(geog geography, use_spheroid boolean)
	RETURNS float8
	AS 'MODULE_PATHNAME','geography_area'
	LANGUAGE 'c' IMMUTABLE STRICT
	;

CREATE OR REPLACE FUNCTION ST_Area(geog geography)
	RETURNS float8
...
-- Availability: 1.5.0
CREATE OR REPLACE FUNCTION ST_Length(geog geography, use_spheroid boolean)
	RETURNS float8
	AS 'MODULE_PATHNAME','geography_length'
	LANGUAGE 'c' IMMUTABLE STRICT
	;

CREATE OR REPLACE FUNCTION ST_Length(geog geography)
	RETURNS float8
...
-- Availability: 2.0.0
CREATE OR REPLACE FUNCTION ST_Perimeter(geog geography, use_spheroid boolean)
	RETURNS float8
	AS 'MODULE_PATHNAME','geography_perimeter'
	LANGUAGE 'c' IMMUTABLE STRICT
	;

CREATE OR REPLACE FUNCTION ST_Perimeter(geog geography)
	RETURNS float8
